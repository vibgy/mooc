...
public class MainActivity extends Activity implements
    ...
    private FrameLayout mFriendsFragmentLayout, mFeedFragmentLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!isInTwoPaneMode()) {
            ...
            //mFriendsFragmentLayout = (FrameLayout) findViewById(R.id.fragment_container);
            FragmentManager mFragmentManager = getFragmentManager();
            FragmentTransaction mFT = mFragmentManager.beginTransaction();
            mFT.add(R.id.fragment_container, mFriendsFragment);
            mFT.commit();
	...
	public void onItemSelected(int position) {
		...
		if (!isInTwoPaneMode()) {
            ...
            mFT.remove(mFriendsFragment);
            mFT.add(R.id.fragment_container, mFeedFragment);
